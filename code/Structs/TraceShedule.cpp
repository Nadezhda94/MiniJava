...
namespace Canon {
	TraceShedule::TraceShedule(BasicBlocks* b) {
		blocks = b;
	...
	shared_ptr<StmtList> TraceShedule::getLast(shared_ptr<StmtList> block) {
	...
	void TraceShedule::trace(shared_ptr<StmtList> l) {
		for (;;) {
	...
	shared_ptr<StmtList> TraceShedule::getNext() {
